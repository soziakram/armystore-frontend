        ...
        <div className="grid row-gap-10 mb-8 lg:grid-cols-6">
          ...
          <div className="md:max-w-md lg:col-span-2">
            <span className="text-base font-medium tracking-wide text-gray-300">
              SUBSCRIPTION FOR NEWS AND PROMOTIONS
            </span>
            <form className="flex flex-col mt-4 md:flex-col ">
              <input
                placeholder="Email"
                required
                type="text"
                className="flex-grow w-full h-12 px-4  mb-3 transition duration-200 bg-white border border-gray-300 rounded shadow-sm appearance-none md:mr-2 md:mb-2 focus:border-green-400 focus:outline-none focus:shadow-outline"
              />
              <button
                type="submit"
          ...
          <div className="flex items-center mt-4 space-x-4 sm:mt-0">
            ...
            >
              <svg
                viewBox="0 0 24 24"
                fill="currentColor"
                className="h-5  hover:text-green-400"
              >
            ...
            >
              <svg
                viewBox="0 0 30 30"
                fill="currentColor"
                className="h-6  hover:text-green-400"
              >
