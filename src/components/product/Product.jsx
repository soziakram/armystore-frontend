...
const Product = () => {
      return (
        <section className="w-screen sm:w-auto flex flex-row overflow-hidden">
          ...
          <div class="w-full lg:w-1/2 px-4">
            <div class="max-w-md mb-6">
              <h2 class="mt-6 mb-4 text-3xl md:text-7xl lg:text-4xl font-heading font-medium">
                khaki hot style jungle boot
              </h2>
              <p class="flex items-center mb-6">
                <span class="mr-2 text-sm text-black font-medium">$</span>
                <span class="text-3xl text-black font-medium">44.90</span>
              </p>
            </div>
            <div class="flex mb-6 items-center">
              ...
              <span class="text-md text-gray-400">4</span>
            </div>
            <div class="mb-6">
